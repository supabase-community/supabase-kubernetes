...
// needs to run again.
func ComputePasswordSyncHash(project *ResourceContext, db *supabasev1alpha1.ResolvedDatabase, dbPassword string) string {
	h := sha256.New()
...
func ComputeJWTSyncHash(project *ResourceContext, db *supabasev1alpha1.ResolvedDatabase, dbPassword, jwtSecret string) string {
	h := sha256.New()
