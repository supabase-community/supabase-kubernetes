...
func EnvoySecretName(project *ResourceContext) string {
	return ComponentName(project.Names["Envoy"], "envoy-auth")
}

// EnvoySecret constructs the dashboard credentials Secret for a Project.
func EnvoySecret(project *ResourceContext) (*corev1.Secret, error) {
