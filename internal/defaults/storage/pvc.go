...
func buildStorageVolumeClaimSpec(project *ResourceContext) corev1.PersistentVolumeClaimSpec {
...
func StoragePVCDeletionPolicy(project *ResourceContext) supabasev1alpha1.DeletionPolicy {
