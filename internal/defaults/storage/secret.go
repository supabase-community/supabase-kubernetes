...
func StorageSecretName(project *ResourceContext) string {
	return ComponentName(project.Names["Storage"], "storage-auth")
}

// StorageSecret constructs the credentials Secret for the Storage component.
func StorageSecret(project *ResourceContext) (*corev1.Secret, error) {
