...
func ProjectMainFunctionName(project *ResourceContext) string {
	return ComponentName(project.Names["EdgeRuntime"], "edge-runtime-main")
}

// ProjectMainFunction constructs the default main Function for a Project.
func ProjectMainFunction(project *ResourceContext) (*supabasev1alpha1.Function, error) {
