...
// Reconciler reconciles a SingleDatabase object.
...
func (r *Reconciler) ensureSecret(ctx context.Context, db *supabasev1alpha1.SingleDatabase) error {
...
func (r *Reconciler) ensurePVC(ctx context.Context, db *supabasev1alpha1.SingleDatabase) error {
...
func (r *Reconciler) ensureService(ctx context.Context, db *supabasev1alpha1.SingleDatabase) error {
...
func (r *Reconciler) ensureStatefulSet(ctx context.Context, db *supabasev1alpha1.SingleDatabase, secretHash string) error {
...
func (r *Reconciler) markReady(ctx context.Context, db *supabasev1alpha1.SingleDatabase) error {
