...
var _ = BeforeSuite(func() {
	...
	err = (&projectcontroller.Reconciler{
	...
	err = (&singledatabasecontroller.Reconciler{
		Client:          mgr.GetClient(),
		Scheme:          mgr.GetScheme(),
	...
	err = (&migrationcontroller.Reconciler{
		Client:          mgr.GetClient(),
		Scheme:          mgr.GetScheme(),
	...
	err = (&functioncontroller.Reconciler{
		Client:          mgr.GetClient(),
		Scheme:          mgr.GetScheme(),
	...
	Expect((&authcontroller.Reconciler{Client: mgr.GetClient(), Scheme: mgr.GetScheme()}).SetupWithManager(mgr)).To(Succeed())

	Expect((&restcontroller.Reconciler{Client: mgr.GetClient(), Scheme: mgr.GetScheme()}).SetupWithManager(mgr)).To(Succeed())

	Expect((&metacontroller.Reconciler{Client: mgr.GetClient(), Scheme: mgr.GetScheme()}).SetupWithManager(mgr)).To(Succeed())

	Expect((&realtimecontroller.Reconciler{Client: mgr.GetClient(), Scheme: mgr.GetScheme()}).SetupWithManager(mgr)).To(Succeed())

	Expect((&storagecontroller.Reconciler{Client: mgr.GetClient(), Scheme: mgr.GetScheme()}).SetupWithManager(mgr)).To(Succeed())

	Expect((&studiocontroller.Reconciler{Client: mgr.GetClient(), Scheme: mgr.GetScheme()}).SetupWithManager(mgr)).To(Succeed())

	Expect((&envoycontroller.Reconciler{Client: mgr.GetClient(), Scheme: mgr.GetScheme()}).SetupWithManager(mgr)).To(Succeed())

	Expect((&edgeruntimecontroller.Reconciler{Client: mgr.GetClient(), Scheme: mgr.GetScheme()}).SetupWithManager(mgr)).To(Succeed())
