...
var _ = Describe("Realtime API", func() {
	It("requires a local immutable Project reference and permits zero replicas", func() {
		...
		defaults := &core.Realtime{ObjectMeta: metav1.ObjectMeta{Name: "defaults", Namespace: ns}, Spec: c.Spec}
