...
var _ = Describe("Studio API", func() {
	It("requires a local immutable Project reference and permits zero replicas", func() {
		...
		defaults := &core.Studio{ObjectMeta: metav1.ObjectMeta{Name: "defaults", Namespace: ns}, Spec: c.Spec}
