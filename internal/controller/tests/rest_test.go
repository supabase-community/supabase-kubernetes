...
var _ = Describe("Rest API", func() {
	It("requires a local immutable Project reference and permits zero replicas", func() {
		...
		c := &core.Rest{ObjectMeta: metav1.ObjectMeta{Name: "arbitrary-name", Namespace: ns}}
		...
		defaults := &core.Rest{ObjectMeta: metav1.ObjectMeta{Name: "defaults", Namespace: ns}, Spec: c.Spec}
