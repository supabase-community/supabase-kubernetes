...
// +kubebuilder:rbac:groups=core.supabase.io,resources=auths/finalizers,verbs=update

func (r *Reconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	obj := &core.Auth{}
	project, result, proceed, err := component.Start(ctx, r.Client, req, obj, &core.AuthList{}, "Auth")
	if err != nil || !proceed {
		return result, err
	}
	...
	state.Owner = obj
	state.Spec.Auth = &obj.Spec
	state.Names["Auth"] = obj.Name
	...
	if err := component.DeploymentReady(ctx, r.Client, client.ObjectKey{Namespace: obj.Namespace, Name: authdefaults.AuthDeploymentName(state)}); err != nil {
...
func (r *Reconciler) SetupWithManager(mgr ctrl.Manager) error {
	return component.SetupWithManager(mgr, r, component.SetupOptions{Object: &core.Auth{}, NewList: func() client.ObjectList { return &core.AuthList{} }, Owns: []client.Object{&appsv1.Deployment{}, &corev1.Service{}}})
}
