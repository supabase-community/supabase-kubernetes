...
// RealtimeReconciler reconciles a Realtime object.
...
func (r *RealtimeReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *RealtimeReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&supabasev1alpha1.Realtime{}).
		Named("realtime").
		Complete(r)
}
